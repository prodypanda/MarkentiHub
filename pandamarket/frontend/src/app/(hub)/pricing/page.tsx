...
export const metadata = {
  title: "Tarifs",
  description:
    "Choisissez le plan parfait pour votre boutique PandaMarket. Gratuit pour commencer, scalable pour grandir.",
};
    ...
    <section style={{ padding: "64px 24px 80px" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h1
            style={{
              fontSize: "var(--pd-fs-4xl)",
              fontWeight: 800,
              marginBottom: 12,
            }}
          >
            Un plan pour chaque{" "}
            <span style={{ color: "var(--pd-green)" }}>ambition</span>
          </h1>
          <p
            style={{
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div style={{ marginBottom: 20 }}>
                <span style={{ fontSize: "var(--pd-fs-3xl)", fontWeight: 800 }}>
              ...
              >
                <div style={{ fontSize: "var(--pd-fs-sm)" }}>
                  <strong>{plan.products}</strong> produits
                </div>
                <div style={{ fontSize: "var(--pd-fs-sm)" }}>
                  <strong>{plan.images}</strong> images
                </div>
                <div style={{ fontSize: "var(--pd-fs-sm)" }}>
                ...
                {featureRows.map((f) => (
                  ...
                  >
                    ...
                    <span
                      style={{
                        color: (plan.features as Record<string, boolean>)[f.key]
                          ? "var(--pd-text-primary)"
