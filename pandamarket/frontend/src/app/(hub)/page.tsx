...
export const metadata = {
  ...
  description:
    "Découvrez des milliers de produits de vendeurs tunisiens vérifiés. Créez votre boutique en ligne gratuite.",
};
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(22,199,132,0.15), transparent 70%)",
          filter: "blur(40px)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Le Marketplace
            <br />
            <span style={{ color: "#16C784" }}>Tunisien</span> nouvelle
            génération
          </h1>
          ...
          >
            {[
              ...
              <div key={stat.label} style={{ textAlign: "center" }}>
                ...
                <div style={{ fontSize: "var(--pd-fs-sm)", color: "#6B7280" }}>
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        >
          <div>
            ...
            <p style={{ color: "#64748b" }}>
              Les derniers produits ajoutés par nos vendeurs
            </p>
          </div>
          <Link
            href="/search"
              ...
              >
                ...
                >
                  ...
                  product.variants[0].prices[0] ? (
                    ...
                    >
                      {(product.variants[0].prices[0].amount / 1000).toFixed(3)}{" "}
                      TND
                    </div>
                  ) : (
                    <div
                    ...
                    >
                      {product.metadata?.price
                        ? Number(product.metadata.price).toFixed(3)
                        : "Prix sur demande"}
                    </div>
                  )}
                </div>
  ...
  const features = [
    {
      ...
      desc: "Sous-domaine gratuit + domaine personnalisable. Choisissez parmi nos thèmes premium.",
    },
    {
      icon: <CreditCard size={24} />,
      title: "Paiement local",
      desc: "Flouci, Konnect, Mandat Minute et paiement à la livraison — tout est intégré.",
    },
    {
      icon: <Shield size={24} />,
      title: "Vendeurs vérifiés",
      desc: "Chaque vendeur passe par notre processus de vérification KYC pour votre sécurité.",
    },
    {
      icon: <Zap size={24} />,
      title: "IA intégrée",
      desc: "Générez des titres SEO et compressez vos images automatiquement.",
    },
    {
      icon: <Truck size={24} />,
      title: "Logistique simplifiée",
      desc: "Aramex et La Poste TN intégrés. Suivi de colis en temps réel.",
    },
    {
      icon: <Sparkles size={24} />,
      title: "Hub Central",
      desc: "Vos produits visibles par des milliers d'acheteurs sur le marketplace.",
    },
  ];

  return (
    <section
      style={{ padding: "80px 24px", backgroundColor: "var(--pd-bg-primary)" }}
    >
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
  ...
  return (
    <section
      style={{
        padding: "80px 24px",
        background:
          "linear-gradient(135deg, #12a56d 0%, #16C784 50%, #1de69a 100%)",
      }}
    >
      <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          Créez votre boutique en 2 minutes. C&apos;est gratuit, sans
          engagement.
        </p>
        <Link
          href="/sell"
