...
export default function SearchPage() {
  ...
  const performSearch = async () => {
    ...
    try {
      ...
      const filterOptions = [];
      if (selectedCategory)
        filterOptions.push(`category = "${selectedCategory}"`);
      filterOptions.push(
          ...
          <Card style={{ position: "sticky", top: 100 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                {Object.entries(facets.category || {}).map(
            ...
            >
              {loading ? (
                  ...
                  >
                    <div
                      style={{
                        ...
                        cursor: "pointer",
                        transition:
                          "transform var(--pd-transition), box-shadow var(--pd-transition)",
                      }}
                ...
                >
                  <SearchIcon
                    size={48}
                    style={{ color: "var(--pd-border)", margin: "0 auto 16px" }}
                  />
                  <h3
                    style={{
