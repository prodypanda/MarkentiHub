        ...
        <div>
              ...
              >
                <div
                  style={{
                    ...
                    backgroundColor:
                      step >= i ? "var(--pd-green)" : "var(--pd-bg-secondary)",
          ...
          {step === 0 && (
            <form onSubmit={handleNext} className="animate-fade-in">
              ...
              <Button type="submit" size="lg" icon={<ArrowRight size={18} />}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    border: `2px solid ${paymentMethod === "flouci" ? "var(--pd-green)" : "var(--pd-border)"}`,
                    backgroundColor:
                ...
                >
                  <div
                    style={{
                      ...
                      height: 24,
                      borderRadius: "50%",
                      border: `6px solid ${paymentMethod === "flouci" ? "var(--pd-green)" : "var(--pd-border)"}`,
                    }}
                  />
                  <div style={{ flex: 1 }}>
                    <h3
                ...
                <div
                  ...
                  style={{
                    padding: 20,
                    borderRadius: "var(--pd-radius-lg)",
                    border: `2px solid ${paymentMethod === "konnect" ? "var(--pd-blue)" : "var(--pd-border)"}`,
                    backgroundColor:
                ...
                >
                  <div
                    style={{
                      ...
                      height: 24,
                      borderRadius: "50%",
                      border: `6px solid ${paymentMethod === "konnect" ? "var(--pd-blue)" : "var(--pd-border)"}`,
                    }}
                  />
                  <div style={{ flex: 1 }}>
                    <h3
                    ...
                    >
                      Paiement sécurisé via Konnect Network
                    </p>
                  </div>
                  <CreditCard
                    size={24}
                ...
                <div
                  ...
                  style={{
                    padding: 20,
                    borderRadius: "var(--pd-radius-lg)",
                    border: `2px solid ${paymentMethod === "cod" ? "var(--pd-yellow)" : "var(--pd-border)"}`,
                    backgroundColor:
                      paymentMethod === "cod"
                        ? "var(--pd-yellow-bg)"
                        : "var(--pd-bg-secondary)",
                ...
                >
                  <div
                    style={{
                      ...
                      height: 24,
                      borderRadius: "50%",
                      border: `6px solid ${paymentMethod === "cod" ? "var(--pd-yellow)" : "var(--pd-border)"}`,
                    }}
                  />
                  <div style={{ flex: 1 }}>
                    <h3
                ...
                <div
                  ...
                  style={{
                    padding: 20,
                    borderRadius: "var(--pd-radius-lg)",
                    border: `2px solid ${paymentMethod === "mandat" ? "var(--pd-text-primary)" : "var(--pd-border)"}`,
                    backgroundColor:
                ...
                >
                  <div
                    style={{
                      ...
                      height: 24,
                      borderRadius: "50%",
                      border: `6px solid ${paymentMethod === "mandat" ? "var(--pd-text-primary)" : "var(--pd-border)"}`,
                    }}
                  />
                  <div style={{ flex: 1 }}>
                    <h3
                    ...
                    >
                      Virement postal. Validation manuelle requise.
                    </p>
                  </div>
                  <Receipt
                    size={24}
          ...
          <Card>
            ...
            >
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                />
                <div style={{ flex: 1 }}>
                  <h4 style={{ fontSize: "var(--pd-fs-sm)", fontWeight: 600 }}>
            ...
            <div
              style={{
                ...
                alignItems: "center",
                paddingTop: 20,
                borderTop: "2px solid var(--pd-border)",
              }}
            >
              <span style={{ fontSize: "var(--pd-fs-base)", fontWeight: 600 }}>
                Total
              </span>
              <span
                style={{
