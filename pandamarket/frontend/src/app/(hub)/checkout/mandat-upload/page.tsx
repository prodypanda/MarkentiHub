  ...
  if (success) {
    return (
      <Card style={{ textAlign: "center", padding: "64px 24px" }}>
        <CheckCircle
          size={64}
          style={{ color: "var(--pd-green)", margin: "0 auto 24px" }}
        />
        <h1
          style={{
        ...
        >
          Nous avons bien reçu votre preuve de paiement. Votre commande sera
          traitée dès que notre équipe aura validé le transfert.
        </p>
  ...
  return (
    <Card style={{ maxWidth: 600, margin: "0 auto" }}>
      ...
      >
        ...
        >
          Veuillez effectuer un Mandat Minute à la Poste au nom de{" "}
          <strong>PandaMarket SARL</strong> (CIN: 12345678). Prenez ensuite une
          photo claire de votre reçu et chargez-la ci-dessous pour valider votre
          commande.
        </p>
      </div>
      ...
      >
        {file ? (
          <div>
            <FileText
              size={48}
              style={{ color: "var(--pd-green)", margin: "0 auto 16px" }}
            />
            <h3 style={{ fontWeight: 600, fontSize: "var(--pd-fs-lg)" }}>
              {file.name}
            </h3>
            <p
              style={{
