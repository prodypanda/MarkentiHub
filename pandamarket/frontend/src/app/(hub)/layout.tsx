...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez des milliers de produits locaux sur PandaMarket. Créez votre boutique en ligne ou achetez directement auprès des meilleurs vendeurs tunisiens.",
  openGraph: {
