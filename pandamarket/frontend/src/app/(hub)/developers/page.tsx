...
export default function DevelopersPortal() {
  useEffect(() => {
    ...
    return () => {
      ...
      if (document.body.contains(presetScript))
  ...
  return (
    <div
      style={{ paddingTop: 100, minHeight: "100vh", backgroundColor: "#fff" }}
    ...
    >
      ...
      >
        ...
        >
          Intégrez votre ERP ou votre application mobile directement via notre
          API REST publique. Générez une clé API depuis votre tableau de bord
          Pro pour commencer.
        </p>
