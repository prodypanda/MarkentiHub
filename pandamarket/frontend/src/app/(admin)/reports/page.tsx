...
const pendingReports = [
  {
    ...
    description: "Le vendeur demande un paiement en dehors de la plateforme.",
    submitted_at: "2026-05-02T14:20:00Z",
    status: "pending",
  },
  {
    id: "rep_2",
    ...
    description: "L'image du produit ne respecte pas les conditions générales.",
    submitted_at: "2026-05-01T11:15:00Z",
    status: "pending",
  },
];
            ...
            <div className="flex justify-between items-start mb-4">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <Badge
                    variant={r.target_type === "Store" ? "danger" : "neutral"}
                  >
                    {r.target_type}
                  </Badge>
