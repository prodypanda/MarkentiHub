...
const pendingMandats = [
  {
    id: "mandat_1",
    store_name: "Tech Store TN",
    order_amount: "150.00 TND",
    order_id: "ord_123",
    submitted_at: "2026-05-02T11:00:00Z",
    status: "pending",
    proof_url: "/mandat-proofs/123.jpg",
  },
  {
    id: "mandat_2",
    store_name: "Mode Fashion",
    order_amount: "45.00 TND",
    order_id: "ord_456",
    submitted_at: "2026-05-01T09:30:00Z",
    status: "pending",
    proof_url: "/mandat-proofs/456.jpg",
  },
];
        ...
        {pendingMandats.map((m) => (
          <Card key={m.id} className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Soumis le:{" "}
                {new Date(m.submitted_at).toLocaleDateString("fr-FR")} à{" "}
                {new Date(m.submitted_at).toLocaleTimeString("fr-FR")}
              </p>
            </div>
