      ...
      <div className="animate-fade-in">
        ...
        <Card style={{ textAlign: "center", padding: 48 }}>
          ...
          <p style={{ color: "var(--pd-text-secondary)" }}>
            Votre boutique est officiellement vérifiée par PandaMarket.
          </p>
          <Badge variant="verified" style={{ marginTop: 16 }}>
            Vendeur vérifié
          </Badge>
        </Card>
      </div>
    ...
    return (
      <div className="animate-fade-in">
        ...
        <Card style={{ textAlign: "center", padding: 48 }}>
          <Clock
            size={56}
            style={{ color: "var(--pd-yellow)", margin: "0 auto 16px" }}
          />
          <h2
            style={{
              fontSize: "var(--pd-fs-xl)",
          ...
          >
            Nos équipes examinent vos documents. Vous serez notifié de la
            décision sous 24-48h.
          </p>
          <Badge variant="warning" dot style={{ marginTop: 16 }}>
            En attente
          </Badge>
        </Card>
      </div>
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p style={{ color: "var(--pd-text-secondary)", marginBottom: 32 }}>
        Soumettez vos documents pour faire vérifier votre boutique et rassurer
        vos acheteurs.
      </p>
      ...
      >
        {[
          { icon: <Shield size={20} />, text: 'Badge "Vendeur vérifié"' },
          {
            ...
            text: "Plus de confiance acheteur",
          },
