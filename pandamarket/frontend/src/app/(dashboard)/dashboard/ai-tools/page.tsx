...
export default function AiToolsPage() {
  ...
  const credits = (creditsData as any)?.credits || {
    ai_tokens_balance: 0,
    ai_tokens_used: 0,
  };
    ...
    <div className="animate-fade-in">
          ...
          style={{
            ...
            backgroundColor:
              toast.type === "success"
                ...
                : "var(--pd-red-bg)",
            color:
              toast.type === "success" ? "var(--pd-green)" : "var(--pd-red)",
            padding: "16px 24px",
      ...
      >
        ...
        >
          ...
          <span style={{ fontWeight: 700, fontSize: "var(--pd-fs-sm)" }}>
            {credits.ai_tokens_balance}
          </span>
          <span
            style={{
      ...
      >
        <Card>
          ...
          >
            Générez un titre optimisé SEO et une description attractive pour vos
            produits avec Gemini Pro.
          </p>
        ...
        <Card>
          ...
          >
            <div
              style={{
                ...
                height: 48,
                borderRadius: "var(--pd-radius-md)",
                backgroundColor: "var(--pd-blue-bg)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                color: "var(--pd-blue)",
          ...
          >
            Compressez vos images produit sans perte visible. WebP optimisé pour
            le web.
          </p>
          <div
            style={{
      ...
      <Card
        style={{
          marginTop: 24,
          background:
            "linear-gradient(135deg, var(--pd-bg-secondary), var(--pd-bg-tertiary))",
        }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              Passez à un plan supérieur pour des crédits inclus, ou achetez des
              packs.
            </p>
          </div>
