...
export default function ProductsPage() {
  ...
  // Wrapped client-side filtering in useMemo to prevent recalculation on every re-render.
  // Hoisted search.toLowerCase() outside the filter loop to avoid O(N) string allocations.
