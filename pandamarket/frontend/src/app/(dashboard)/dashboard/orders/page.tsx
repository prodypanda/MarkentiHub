...
export default function OrdersPage() {
  ...
  // ⚡ Bolt Optimization: Wrap filtering in useMemo and hoist toLowerCase out of loop
  // Expected impact: Prevents redundant string allocations and reduces unnecessary component re-renders
  const filtered = useMemo(() => {
    const lowerSearch = search.toLowerCase();
    return rawOrders.filter((o: any) => {
      const matchSearch = !lowerSearch || String(o.id).toLowerCase().includes(lowerSearch) ||
