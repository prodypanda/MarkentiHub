    ...
    <Card>
      ...
      >
        <div>
          ...
          >
            {positive ? (
              <ArrowUpRight size={14} style={{ color: "var(--pd-green)" }} />
            ) : (
              <ArrowDownRight size={14} style={{ color: "var(--pd-red)" }} />
            )}
            <span
              style={{
                fontSize: "var(--pd-fs-xs)",
                color: positive ? "var(--pd-green)" : "var(--pd-red)",
                fontWeight: 600,
              }}
            >
              {change}
  ...
  return (
    <div className="animate-fade-in">
      ...
      <Card>
        ...
        >
          <h2 style={{ fontSize: "var(--pd-fs-lg)", fontWeight: 700 }}>
            Commandes récentes
          </h2>
          <a
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {recentOrders.map((order) => (
                <tr
                  key={order.id}
                  style={{ transition: "background var(--pd-transition)" }}
                >
                  <td
                    style={{
                      padding: "12px",
                  ...
                  <td style={{ padding: "12px", fontSize: "var(--pd-fs-sm)" }}>
                    {order.customer}
                  </td>
                  <td
                    style={{
