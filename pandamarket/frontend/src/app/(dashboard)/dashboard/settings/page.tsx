    ...
    <div className="animate-fade-in">
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        >
          ...
          <Button icon={<Save size={16} />} style={{ alignSelf: "flex-start" }}>
            Enregistrer
          </Button>
        </div>
      </Card>
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        >
          ...
          <Input
            ...
            placeholder="www.votre-domaine.tn"
            icon={<Globe size={16} />}
            hint="Disponible à partir du plan Starter"
          />
        </div>
      </Card>
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        >
          <label style={{ fontSize: "var(--pd-fs-sm)", fontWeight: 500 }}>
            Couleur principale
          </label>
          <input
            type="color"
      ...
      <Card>
        ...
        >
          ...
          >
            Générez une clé API pour connecter votre boutique à des applications
            tierces (Plan Pro requis).
          </p>
          <Button
            variant="outline"
            onClick={async () => {
              try {
                ...
                const res = await fetch("/api/pd/api-keys", {
                  method: "POST",
                  body: JSON.stringify({ label: "Nouvelle Clé" }),
                  headers: { "Content-Type": "application/json" },
                });
                const data = await res.json();
                if (data.raw_key) {
                  alert(
                    `Votre clé API: ${data.raw_key}\nCopiez-la maintenant, elle ne sera plus affichée.`,
                  );
                }
              } catch (e) {
          ...
          >
            <Input
              label="Webhook URL (Notification commandes)"
      ...
      <Card>
        ...
        >
          ...
          >
            ...
            >
              En activant les paiements directs, les fonds vont directement sur
              votre propre compte marchand (Plan Pro requis).
            </p>
