  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(135deg, var(--pd-bg-primary) 0%, var(--pd-bg-tertiary) 100%)",
        padding: "var(--pd-sp-4)",
      }}
    >
      <div style={{ width: "100%", maxWidth: 480 }} className="animate-fade-in">
            ...
            <div key={s} style={{ flex: 1, textAlign: "center" }}>
              <div
                style={{
                  ...
                  marginBottom: 8,
                  backgroundColor:
                    i <= step ? "var(--pd-green)" : "var(--pd-border)",
              ...
              <span
                style={{
                  ...
                  fontWeight: 600,
                  color:
                    i <= step ? "var(--pd-green)" : "var(--pd-text-tertiary)",
                }}
              >
                {s}
              </span>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 1 && (
            ...
            >
              ...
              <div>
                ...
                >
                  {form.subdomain
                    ? `${form.subdomain}.pandamarket.tn`
                    : "votre-boutique.pandamarket.tn"}
                </p>
              </div>
              <div>
                <label
          ...
          {step === 2 && (
            ...
            >
              ...
              >
                <p>
                  <strong>Boutique:</strong> {form.store_name}
                </p>
                <p>
                  <strong>URL:</strong> {form.subdomain}.pandamarket.tn
                </p>
                <p>
                  <strong>Plan:</strong> Free (10 produits, 15% commission)
                </p>
                <p>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 24 }}>
            ...
            <Button type="submit" loading={loading} fullWidth size="lg">
              {step < 2 ? "Suivant" : "Créer ma boutique"}{" "}
              <ArrowRight size={18} />
            </Button>
          </div>
        </form>
        ...
        >
          ...
          <Link
            href="/login"
            style={{ color: "var(--pd-green)", fontWeight: 600 }}
          >
            Se connecter
          </Link>
        </p>
