---
name: PandaMarket
description: PandaArchitect is a specialized AI development agent designed to build **PandaMarket**, a production-grade hybrid platform combining a **SaaS Storefront Builder** (like Shopify) with a **Central Marketplace Hub** (like Amazon), targeting the **Tunisian market**.
---
